...
//EDIT-HERE: set to the type of Sports New-Shows to include. Uncomment only the
//type you desire

//$NewSportsQueryType = 'Sports%';  // Note: this selection return everything! It
                                  // is limited though by $NewShowsQueryLimit
                                  // setting
...
// EDITs are not normally needed below. Note: SD works for heterogenous
// households (for both HD and SD televisions)
...
$PWS=false;  //use local user stations for reporting see
...
$API_KEY='8d114d04cff24445';  //NOTE: wunderground limits use velocity so this
                              //may become obsolete without warning.
